...
public class RangeSeekBar<T extends Number> extends android.support.v7.widget.AppCompatImageView {
    ...
    private static final int LINE_HEIGHT_IN_DP = 20;
    ...
    private void init(Context context, AttributeSet attrs) {
        float barHeight;
        int thumbNormal = R.drawable.thumb_normal;
        int thumbPressed = R.drawable.thumb_disabled;
        int thumbDisabled = R.drawable.thumb_disabled;
...
//            activeColor = ACTIVE_COLOR;
            ...
            defaultColor = ContextCompat.getColor(context, R.color.app_color_medium);
            alwaysActive = false;
...
//                textAboveThumbsColor = a.getColor(R.styleable.RangeSeekBar_textAboveThumbsColor, Color.WHITE);
                textAboveThumbsColor = a.getColor(R.styleable.RangeSeekBar_textAboveThumbsColor,
                        ContextCompat.getColor(context, R.color.app_color_medium));
...
//                Drawable normalDrawable = a.getDrawable(R.styleable.RangeSeekBar_thumbNormal);
                Drawable normalDrawable = ContextCompat.getDrawable(context, R.drawable.thumb_normal);
                if (normalDrawable != null) {
                    thumbImage = BitmapUtil.drawableToBitmap(normalDrawable);
                }
                Drawable disabledDrawable = ContextCompat.getDrawable(context, R.drawable.thumb_disabled);
//                Drawable disabledDrawable = a.getDrawable(R.styleable.RangeSeekBar_thumbDisabled);
                ...
                Drawable pressedDrawable = ContextCompat.getDrawable(context, R.drawable.thumb_disabled);
...
//        thumbHalfWidth = thumbImage.getWidth();
//        thumbHalfHeight = thumbImage.getHeight();
