...
public class LocationFilterFragmentBc extends DialogFragment implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener,
    ...
    public LocationFilterFragmentBc() {
        // Required empty public constructor
    }

    public static LocationFilterFragmentBc newInstance(String param1, String param2) {
        LocationFilterFragmentBc fragment = new LocationFilterFragmentBc();
    ...
    public static LocationFilterFragmentBc newInstance(int param1) {
        LocationFilterFragmentBc fragment = new LocationFilterFragmentBc();
        Bundle args = new Bundle();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (rootView == null) {
            rootView = View.inflate(getContext(), R.layout.fragment_location_radius_bc, null);
        }
        initComponents();
        return rootView;
    }
