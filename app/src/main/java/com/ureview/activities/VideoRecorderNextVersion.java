...
public class VideoRecorderNextVersion extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_recorder_next_release);
        ...
        cutVideo.setOnClickListener(v -> {
            ...
            if (selectedVideoUri != null) {
                if (rangeSeekBar.getSelectedMaxValue().intValue() - rangeSeekBar.getSelectedMinValue().intValue() > 59) {
                    StaticUtils.showToast(VideoRecorderNextVersion.this, "Video cannot be more than 60 seconds in duration");
                }
